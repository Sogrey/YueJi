...
class ColorUtils {
    companion object {
        ...
        private val regHex = "^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$"
        private val regRgb = "^(RGB\\(|rgb\\()([0-9]{1,3},){2}[0-9]{1,3}\\)$"
        private val regRepRgb = "(rgb|\\(|\\)|RGB)*"
        ...
        fun hex2Rgb(hex: String): String? {
            ...
            val c = RegUtils.replace(hex.toUpperCase(), "#", "")
        ...
        fun rgb2Hex(rgb: String): String? {
            ...
            val r = Integer.toHexString(getRed(rgb)).toUpperCase()
            val g = Integer.toHexString(getGreen(rgb)).toUpperCase()
            val b = Integer.toHexString(getBlue(rgb)).toUpperCase()
