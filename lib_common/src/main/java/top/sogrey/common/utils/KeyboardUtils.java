...
public class KeyboardUtils {
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        LogKtUtils.Companion.d("KeyboardUtils", "getDecorViewInvisibleHeight: "
    ...
    private static int getContentViewInvisibleHeight(final Window window) {
        ...
        LogKtUtils.Companion.d("KeyboardUtils", "getContentViewInvisibleHeight: "
    ...
    public static void clickBlankArea2HideSoftInput() {
        LogKtUtils.Companion.d("KeyboardUtils", "Please refer to the following code.");
        /*
        @Override
